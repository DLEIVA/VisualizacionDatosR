...
[`flexdashboard`](https://pkgs.rstudio.com/flexdashboard/) permite generar cuadros de mandos en RMarkdown.
...
Shiny () permite crear aplicaciones web de forma fácil en RStudio.
Se instala como cualquier otro paquete de R:
install.packages("flexdashboard")
Contiene ejemplos que pueden ser inspeccionados mediante la instrucción:
runExample(“NOMBRE EJEMPLO")
